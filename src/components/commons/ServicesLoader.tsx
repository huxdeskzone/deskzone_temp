...
const ServicesLoader: React.FC = () => {
  ...
  return (
    <section className="w-full my-5 px-4 pb-9 pt-5 md:px-6 md:pb-10 md:pt-6 lg:px-7 lg:pb-12 3xl:px-8 ">
      <div className="-z-10 grid grid-cols-1 gap-5 sm:grid-cols-2 md:grid-cols-3 lg:gap-6 3xl:gap-7 xl:grid-cols-4 2xl:grid-cols-6 3xl:grid-cols-6 4xl:grid-cols-[repeat(auto-fill,minmax(300px,1fr))]">
